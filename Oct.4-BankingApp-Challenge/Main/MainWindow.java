...
public class MainWindow implements ActionListener{
	...
	public JFrame frame1 = new JFrame("YourBankingApp"); // Create our window frame and name it "YourBankingApp".
	...
	public MainWindow(){
		...
		//Person personCameron = new Person("Cameron ", "Brenton", new Address("122 Lloyd Street", "St.Johns", "Newfoundland & Labrador", "EEE 222"));

		//UserAccount userCameron = new UserAccount(personCameron, "i01c", "Spaghetti");
		//SavingsAccount savingsAccount = new SavingsAccount(personCameron, new Money(100000000));
		//CheckingAccount checkingAccount = new CheckingAccount(personCameron, new Money(100000000));	
